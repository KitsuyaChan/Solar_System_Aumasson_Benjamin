...
public class Planet extends CorpsCeleste{
    ...
    public void add_satellite(Satellite s){ satellites.add(s); }

    public List<Satellite> getSatellites() { return satellites; }
    public int getRevolution() { return revolution; }
    public double getRevolution_current() { return revolution_current; }
    public int getDistance_orbit() { return distance_orbit; }
    public int getId_orbit() { return id_orbit; }
    ...
    public void setRevolution_current(double revolution_current) { this.revolution_current = revolution_current; }
    public void setDistance_orbit(int distance_orbit) { this.distance_orbit = distance_orbit; }
    public void setId_orbit(int id_orbit) { this.id_orbit = id_orbit; }



    public void addSatellite(Satellite s){ satellites.add(s); }
    public double hour_to_degre(double h){ return 360.0/this.getRevolution() * h; }
    ...
    public void turn(){
        ...
        for(Satellite s:satellites){ s.turn_s(this.getPosition()); }
    }
}
